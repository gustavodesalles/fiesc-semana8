	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				String opMotivo = input.nextLine();
				opMotivo = opMotivo.toUpperCase();

				if (opMotivo.equals("VINGANÇA") || opMotivo.equals("VINGANCA")) {
					jogador.setMotivacao(Motivacao.VINGANCA);
					repetir = false;
				} else if (opMotivo.equals("GLÓRIA") || opMotivo.equals("GLORIA")) {
